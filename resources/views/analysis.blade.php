                ...
                success: function (data) {
                    if ('0000' === data.code) {
                        ...
                        $.each(data.data, function (index) {
                            tbody.append("<tr><td>" + data.data[index]['router'] + "</td><td class='center aligned'>" + data.data[index]['method'] + "</td><td class='center aligned'>" + data.data[index]['count'] + "</td><td class='center aligned'>" + data.data[index]['max'] + "</td><td class='center aligned'>" + data.data[index]['min'] + "</td><td class='center aligned'>" + data.data[index]['average'] + "</td></tr>");
                        });
